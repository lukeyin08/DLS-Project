const STORAGE_KEY = "after-last-interview-state-v1";
...
function renderHub() {
  ...
  return `
    ...
    <p>Follow the recurring phrase when it appears. Click redactions when they seem too polished. Return to earlier pages after later pages make them less comfortable. This interface remembers what you have opened and keeps count of the places where the same language was used to turn testimony into evidence.</p>
  `;
}
