...
3. Reading progress is session-only. If you refresh the page, the archive starts over from scratch.
...
The site tracks reading progress in in-memory runtime state:
